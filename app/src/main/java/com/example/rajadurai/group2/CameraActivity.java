...
import com.example.rajadurai.group2.rendering.AugmentedImageRenderer;
...
public class CameraActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        try {
            ...
            //Here we should loop for images in database
    ...
    private boolean setupAugmentedImageDatabase(Config config) {
        ...
        if (useSingleImage) {
            ...
            try (InputStream is = getAssets().open("numbersmachinedb.imgdb")) {
